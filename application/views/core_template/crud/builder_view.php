            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <?php } elseif ($relation) {?>  <div class="form-group ">
                    ...
                    <?php } elseif ($this->crud_builder->getFieldByType('date', $input) || $this->crud_builder->getFieldByType('datetime', $input)) {?>  <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label"><?= ucwords(clean_snake_case($option['label'])); ?> </label>

                        <div class="col-sm-8">
                           {php_open_tag_echo} _ent(format_date_id(${table_name}-><?= $input; ?>)); {php_close_tag}
                        </div>
                    </div>
