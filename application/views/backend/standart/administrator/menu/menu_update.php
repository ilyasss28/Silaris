<?php
/**
 * Variables supplied by Menu::edit() through the CodeIgniter view loader.
 * These declarations are for static analysis only and do not change runtime
 * values or add fallback data that could conceal a controller error.
 *
 * @var CI_Controller          $this
 * @var stdClass               $menu
 * @var array<int, string>     $color_icon
 * @var array<int, int|string> $group_menu
 */
?>

<?php
if (!isset($menu) || !is_object($menu)) {
    throw new UnexpectedValueException('Menu::edit() must provide menu data to the update view.');
}
?>
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc"> <?= cclang('update', ['Menu']); ?></h5>
                     <hr>
                  </div>
                   ...
                   ?>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input <?= $menu->type == 'menu' ? 'checked' : ''; ?> type="radio" name="type" class="flat-red menu_type" value="menu"> <?= cclang('menu'); ?>
                            </label>
                            <label>
                            <input <?= $menu->type == 'label' ? 'checked' : ''; ?> type="radio" name="type" class="flat-red menu_type" value="label"> <?= cclang('label'); ?>
                            </label>
                            <small class="info help-block">
                             Type Of Menu.
                          </small>
