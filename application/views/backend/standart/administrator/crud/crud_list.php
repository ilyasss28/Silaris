...
<script>
                 ...
                 function(isConfirm) {
                     if (isConfirm) {
                         ...
                         if (!selectedIds.length) {
                            swal('Upss', 'Pilih minimal satu CRUD terlebih dahulu.', 'warning');
                            return;
                         }
                         submitCrudDelete(selectedIds);
                     }
                 });
 ...
 function submitCrudDelete(ids) {
    var form = $('<form>', { method: 'post', action: BASE_URL + '/administrator/crud/delete' });
