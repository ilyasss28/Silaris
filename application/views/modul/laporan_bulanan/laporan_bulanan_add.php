                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Laporan Bulanan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="laporan_bulanan_file_laporan_uuid" id="laporan_bulanan_file_laporan_uuid" type="hidden" value="<?= set_value('laporan_bulanan_file_laporan_uuid'); ?>">
                                <input class="data_file" name="laporan_bulanan_file_laporan_name" id="laporan_bulanan_file_laporan_name" type="hidden" value="<?= set_value('laporan_bulanan_file_laporan_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/laporan_bulanan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file_laporan = $('#laporan_bulanan_file_laporan_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file_laporan !== 'undefined') {
                    $('#laporan_bulanan_file_laporan_galery').fineUploader('deleteFile', id_file_laporan);
                }
