                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('laporan_bulanan/edit_save/'.$this->uri->segment(3)), [
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_laporan"  placeholder="Tanggal Laporan" id="tanggal_laporan" value="<?= set_value('laporan_bulanan_tanggal_laporan_name', $laporan_bulanan->tanggal_laporan); ?>">
                            </div>
