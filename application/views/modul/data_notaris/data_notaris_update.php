                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('data_notaris/edit_save/'.$this->uri->segment(3)), [
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_lahir"  placeholder="Tanggal Lahir" id="tanggal_lahir" value="<?= set_value('data_notaris_tanggal_lahir_name', $data_notaris->tanggal_lahir); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
