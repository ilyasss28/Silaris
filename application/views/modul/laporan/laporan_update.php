                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Laporan</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('laporan/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_laporan', 
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="Tanggal_Laporan"  placeholder="Tanggal Laporan" id="Tanggal_Laporan" value="<?= set_value('laporan_Tanggal_Laporan_name', $laporan->Tanggal_Laporan); ?>">
                            </div>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="laporan_Laporan_uuid" id="laporan_Laporan_uuid" type="hidden" value="<?= set_value('laporan_Laporan_uuid'); ?>">
                                <input class="data_file" name="laporan_Laporan_name" id="laporan_Laporan_name" type="hidden" value="<?= set_value('laporan_Laporan_name', $laporan->Laporan); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#laporan_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#laporan_Laporan_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'laporan/get_Laporan_file/<?= $laporan->id; ?>',
