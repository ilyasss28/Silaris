...
<input type="date" class="form-control pull-right native-date-input" name="Tanggal_Laporan" id="Tanggal_Laporan" value="<?= set_value('laporan_Tanggal_Laporan_name', $laporan->Tanggal_Laporan); ?>">
                            </div>
