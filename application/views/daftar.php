      ...
      <div class="col-lg-8 mt-8 mt-lg-0 ">
        <div class="row"> 
          ...
          <div class="col-lg-3 mt-4 mt-lg-0 ">
            <div class="member">
              <a href="<?php echo base_url('detail/detail/').$id_notaris?>"><img src="<?php echo base_url('assets/uploads/foto_profil/')?><?php echo $foto; ?>" alt=""></a>
              <a href="<?= base_url()?>detail/detail/<?=$id_notaris; ?>"><h4><?php echo $nama_notaris; ?></h4></a>
