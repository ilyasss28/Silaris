...
class CI_Profiler
{
    ...
    /**
     * Flags for compiled sections
     *
     * @var array
     */
    protected $_compile_flags = array();
    ...
    public function __construct($config = array())
    {
        ...
        foreach ($this->_available_sections as $section)
        {
            ...
            {
                $this->_compile_flags[$section] = TRUE;
            }
        }
    ...
    public function set_sections($config)
    {
        ...
        foreach ($config as $method => $enable)
        {
            ...
            {
                $this->_compile_flags[$method] = ($enable !== FALSE);
            }
        }
    }
    ...
    public function run()
    {
        foreach ($this->_available_sections as $section)
        {
            if (isset($this->_compile_flags[$section]) && $this->_compile_flags[$section] !== FALSE)
            {
